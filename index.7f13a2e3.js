...
`,b=t=>{let r=document.createElement("template");return r.innerHTML=`
    <style>${t}</style>
...
`,v=t=>{let r=document.createElement("template");return r.innerHTML=`
  ...
  `,r};class y extends HTMLElement{#o=[];#i=0;#n=0;#s=0;#l=-1;#a=new Set;#c=new Set;#d=null;#u=null;#h=null;#m=null;#p=null;#b=null;#g=null;#f=null;#w=null;constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(v(w).content.cloneNode(!0))}get sequential(){return this.hasAttribute("sequential")}set sequential(e){this.toggleAttribute("sequential",!!e)}get multipleChoice(){return this.hasAttribute("multiple-choice")}set multipleChoice(e){this.toggleAttribute("multiple-choice",!!e)}connectedCallback(){this.#v("sequential"),this.#v("multipleChoice"),this.#u=this.shadowRoot.getElementById("answerForm"),this.#h=this.shadowRoot.getElementById("question"),this.#m=this.shadowRoot.getElementById("answerInput"),this.#p=this.shadowRoot.getElementById("feedback"),this.#b=this.shadowRoot.getElementById("score"),this.#g=this.shadowRoot.getElementById("progress"),this.#f=this.shadowRoot.getElementById("multipleChoice"),this.#w=this.shadowRoot.getElementById("quitQuiz"),this.#u.addEventListener("submit",this.#t),this.#f.addEventListener("click",this.#y),this.#w.addEventListener("click",this.#C),this.#E(),this.multipleChoice?(this.#m.setAttribute("disabled",""),this.#m.setAttribute("inert",""),this.#m.setAttribute("type","text")):this.#m.focus()}disconnectedCallback(){this.#u.removeEventListener("submit",this.#t),this.#f.removeEventListener("click",this.#y),this.#w.addEventListener("click",this.#C),null!==this.#d&&(clearTimeout(this.#d),this.#d=null)}#E(){this.#o=this.#x(),this.#n=this.#o.length,this.#k()}#t=e=>{e.preventDefault(),null===this.#d&&this.#q()};#y=e=>{let t=e.target.closest("button");null===this.#d&&t&&(this.#m.value=t.textContent,this.#q())};#z=()=>{this.dispatchEvent(new Event("quiz-restart",{bubbles:!0,composed:!0}))};#C=()=>{if(1===this.#s&&null===this.#d)return this.#z();confirm(h("quitQuizConfirm"))&&this.#z()};#x(){let e=[];for(let t=1;t<=10;t+=1)for(let r=1;r<=10;r+=1){let o=t*r;e.push({factor1:t,factor2:r,product:o})}return this.multipleChoice&&e.forEach(t=>{for(t.answerChoices=[t.product];t.answerChoices.length<3;){let r=e[Math.floor(Math.random()*e.length)].product;t.answerChoices.includes(r)||t.answerChoices.push(r)}t.answerChoices=function(e){if(!Array.isArray(e))throw TypeError("Expected an array for first argument");let t=[...e],r=t.length;for(;r;){let e=Math.random()*r--|0,o=t[r];t[r]=t[e],t[e]=o}return t}(t.answerChoices)}),e}#k(){this.sequential?this.#A():this.#Q(),this.#S(),this.#L()}#A(){this.#l+=1;let e=this.#o[this.#l];if(this.#l<this.#n){let{factor1:t,factor2:r}=e;this.#h.textContent=`${t} x ${r} =`,this.multipleChoice&&this.#$(e.answerChoices)}else this.#I()}#Q(){let e;if(this.#a.size===this.#n){this.#I();return}do this.#l=Math.floor(Math.random()*this.#n),e=this.#o[this.#l];while(this.#a.has(`${e.factor1}-${e.factor2}`))this.#a.add(`${e.factor1}-${e.factor2}`),this.#h.textContent=`${e.factor1} x ${e.factor2} =`,this.multipleChoice&&this.#$(e.answerChoices)}#$(e){this.#f.replaceChildren(),e.forEach(e=>{let t=document.createElement("button");t.setAttribute("data-answer",e),t.type="button",t.textContent=e,this.#f.appendChild(t)})}#q(){let e=parseInt(this.#m.value,10),t=this.#o[this.#l],r=t.product,o=1e3;if(this.multipleChoice){if(this.#f.setAttribute("inert",""),e===r)this.#f.querySelector(`button[data-answer="${r}"]`).classList.add("correct"),this.#m.classList.add("correct"),this.#i+=1;else{let i=this.#f.querySelector(`button[data-answer="${r}"]`),n=this.#f.querySelector(`button[data-answer="${e}"]`);i.classList.add("correct"),n.classList.add("incorrect"),this.#m.classList.add("incorrect"),o=2e3,this.#c.add({question:`${t.factor1} x ${t.factor2}`,userAnswer:e,correctAnswer:r})}}else this.#m.style.pointerEvents="none",e===r?(this.#p.innerHTML=`
        ...
        `,o=2e3,this.#c.add({question:`${t.factor1} x ${t.factor2}`,userAnswer:e,correctAnswer:r}));this.#S(),this.#d=setTimeout(()=>{this.#m.value="",this.#m.focus(),this.#k(),this.#d=null,this.multipleChoice?(this.#f.removeAttribute("inert"),this.#m.classList.remove("correct","incorrect"),this.#f.querySelectorAll("button").forEach(e=>{e.classList.remove("correct","incorrect")})):(this.#m.style.pointerEvents="auto",this.#p.replaceChildren())},o)}#S(){this.#b.textContent=this.#i}#L(){this.#s+=1,this.#g.value=this.#s/this.#n}#I(){this.shadowRoot.getElementById("quiz").innerHTML=`
