!function(){function e(e,t,i,o){Object.defineProperty(e,t,{get:i,set:o,enumerable:!0,configurable:!0})}function t(e){return e&&e.__esModule?e.default:e}var i="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},o={},r={},s=i.parcelRequireed01;null==s&&((s=function(e){if(e in o)return o[e].exports;if(e in r){var t=r[e];delete r[e];var i={id:e,exports:{}};return o[e]=i,t.call(i.exports,i,i.exports),i.exports}var s=Error("Cannot find module '"+e+"'");throw s.code="MODULE_NOT_FOUND",s}).register=function(e,t){r[e]=t},i.parcelRequireed01=s);var n=s.register;n("iE7OH",function(t,i){e(t.exports,"register",function(){return o},function(e){return o=e});var o,r=new Map;o=function(e,t){for(var i=0;i<t.length-1;i+=2)r.set(t[i],{baseUrl:e,path:t[i+1]})}}),n("aNJCr",function(t,i){e(t.exports,"getBundleURL",function(){return o},function(e){return o=e});var o,r={};o=function(e){var t=r[e];return t||(t=function(){try{throw Error()}catch(t){var e=(""+t.stack).match(/(https?|file|ftp|(chrome|moz|safari-web)-extension):\/\/[^)\n]+/g);if(e)return(""+e[2]).replace(/^((?:https?|file|ftp|(chrome|moz|safari-web)-extension):\/\/.+)\/[^/]+$/,"$1")+"/"}return"/"}(),r[e]=t),t}}),s("iE7OH").register(s("aNJCr").getBundleURL("9p9yL"),JSON.parse('["9p9yL","index.0f9c2a2a.js","83LPa","logo-light.50757842.png","cegw3","logo-dark.33c21a11.png","gHlXF","celebration.228925ff.png","jm0TH","index.7dbac5dd.css"]'));let l="multiply-quiz",a=new class{constructor(e="session"){this.storage="local"===e?localStorage:sessionStorage}getItem(e){try{return JSON.parse(this.storage.getItem(`${l}/${e}`))}catch{return null}}setItem(e,t){try{this.storage.setItem(`${l}/${e}`,JSON.stringify(t))}catch{}}};var c={};c=s("aNJCr").getBundleURL("9p9yL")+"logo-light.50757842.png";var u={};u=s("aNJCr").getBundleURL("9p9yL")+"logo-dark.33c21a11.png";let d=`
  :host {
    display: grid;
    place-items: center;
    height: 100%;
...
`,h=`
  ...
  <form>
    <picture>
      <source srcset="${/*@__PURE__*/t(c)}" media="(prefers-color-scheme: dark)">
      <source srcset="${/*@__PURE__*/t(u)}" media="(prefers-color-scheme: light)">
      <img src="${/*@__PURE__*/t(u)}" alt="Quiz" width="120" height="120" aria-hidden="true">
    </picture>
...
`,m=document.createElement("template");m.innerHTML=h;class p extends HTMLElement{#e=null;constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(m.content.cloneNode(!0))}connectedCallback(){this.#e=this.shadowRoot.querySelector("form"),this.#e.addEventListener("submit",this.#t),this.#e.addEventListener("change",this.#i);let e=a.getItem("options");e&&(this.#e.sequential.checked=e.sequential,this.#e["multiple-choice"].checked=e.multipleChoice)}disconnectedCallback(){this.#e.removeEventListener("submit",this.#t),this.#e.removeEventListener("change",this.#i)}#i=()=>{let e=this.#e.sequential.checked,t=this.#e["multiple-choice"].checked;a.setItem("options",{sequential:e,multipleChoice:t})};#t=e=>{e.preventDefault(),this.dispatchEvent(new CustomEvent("quiz-start",{bubbles:!0,composed:!0,detail:{sequential:e.target.sequential.checked,multipleChoice:e.target["multiple-choice"].checked}}))};static defineCustomElement(e="quiz-intro"){"undefined"==typeof window||window.customElements.get(e)||window.customElements.define(e,p)}}var f={};f=s("aNJCr").getBundleURL("9p9yL")+"celebration.228925ff.png";let b=`
  :host {
    display: grid;
...
`,w=document.createElement("template");w.innerHTML=g;class v extends HTMLElement{#o=[];#r=0;#s=0;#n=0;#l=-1;#a=new Set;#c=new Set;#u=null;#d=null;#h=null;#m=null;#p=null;#f=null;#b=null;#g=null;#w=null;constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(w.content.cloneNode(!0))}get sequential(){return this.hasAttribute("sequential")}set sequential(e){this.toggleAttribute("sequential",!!e)}get multipleChoice(){return this.hasAttribute("multiple-choice")}set multipleChoice(e){this.toggleAttribute("multiple-choice",!!e)}connectedCallback(){this.#v("sequential"),this.#v("multipleChoice"),this.#d=this.shadowRoot.getElementById("answerForm"),this.#h=this.shadowRoot.getElementById("question"),this.#m=this.shadowRoot.getElementById("answerInput"),this.#p=this.shadowRoot.getElementById("feedback"),this.#f=this.shadowRoot.getElementById("score"),this.#b=this.shadowRoot.getElementById("progress"),this.#g=this.shadowRoot.getElementById("multipleChoice"),this.#w=this.shadowRoot.getElementById("quitQuiz"),this.#d.addEventListener("submit",this.#t),this.#g.addEventListener("click",this.#y),this.#w.addEventListener("click",this.#E),this.#C(),this.multipleChoice?(this.#m.setAttribute("disabled",""),this.#m.setAttribute("type","text")):this.#m.focus()}disconnectedCallback(){this.#d.removeEventListener("submit",this.#t),this.#g.removeEventListener("click",this.#y),this.#w.addEventListener("click",this.#E),null!==this.#u&&(clearTimeout(this.#u),this.#u=null)}#C(){this.#o=this.#x(),this.#s=this.#o.length,this.#q()}#t=e=>{e.preventDefault(),null===this.#u&&this.#k()};#y=e=>{let t=e.target.closest("button");null===this.#u&&t&&(this.#m.value=t.textContent,this.#k())};#z=()=>{this.dispatchEvent(new Event("quiz-restart",{bubbles:!0,composed:!0}))};#E=()=>{if(1===this.#n&&null===this.#u)return this.#z();confirm("Quit the quiz? Your progress will be lost.")&&this.#z()};#x(){let e=[];for(let t=1;t<=10;t+=1)for(let i=1;i<=10;i+=1){let o=t*i;e.push({factor1:t,factor2:i,product:o})}return this.multipleChoice&&e.forEach(t=>{for(t.answerChoices=[t.product];t.answerChoices.length<3;){let i=e[Math.floor(Math.random()*e.length)].product;t.answerChoices.includes(i)||t.answerChoices.push(i)}t.answerChoices=function(e){if(!Array.isArray(e))throw TypeError("Expected an array for first argument");let t=[...e],i=t.length;for(;i;){let e=Math.random()*i--|0,o=t[i];t[i]=t[e],t[e]=o}return t}(t.answerChoices)}),e}#q(){this.sequential?this.#Q():this.#A(),this.#L(),this.#S()}#Q(){this.#l+=1;let e=this.#o[this.#l];if(this.#l<this.#s){let{factor1:t,factor2:i}=e;this.#h.textContent=`${t} x ${i} =`,this.multipleChoice&&this.#I(e.answerChoices)}else this.#$()}#A(){let e;if(this.#a.size===this.#s){this.#$();return}do this.#l=Math.floor(Math.random()*this.#s),e=this.#o[this.#l];while(this.#a.has(`${e.factor1}-${e.factor2}`))this.#a.add(`${e.factor1}-${e.factor2}`),this.#h.textContent=`${e.factor1} x ${e.factor2} =`,this.multipleChoice&&this.#I(e.answerChoices)}#I(e){this.#g.replaceChildren(),e.forEach(e=>{let t=document.createElement("button");t.setAttribute("data-answer",e),t.type="button",t.textContent=e,this.#g.appendChild(t)})}#k(){let e=parseInt(this.#m.value,10),t=this.#o[this.#l],i=t.product,o=1e3;if(this.multipleChoice){if(this.#g.setAttribute("inert",""),e===i)this.#g.querySelector(`button[data-answer="${i}"]`).classList.add("correct"),this.#m.classList.add("correct"),this.#r+=1;else{let r=this.#g.querySelector(`button[data-answer="${i}"]`),s=this.#g.querySelector(`button[data-answer="${e}"]`);r.classList.add("correct"),s.classList.add("incorrect"),this.#m.classList.add("incorrect"),o=2e3,this.#c.add({question:`${t.factor1} x ${t.factor2}`,userAnswer:e,correctAnswer:i})}}else this.#m.style.pointerEvents="none",e===i?(this.#p.innerHTML=`
        ...
        `,o=2e3,this.#c.add({question:`${t.factor1} x ${t.factor2}`,userAnswer:e,correctAnswer:i}));this.#L(),this.#u=setTimeout(()=>{this.#m.value="",this.#m.focus(),this.#q(),this.#u=null,this.multipleChoice?(this.#g.removeAttribute("inert"),this.#m.classList.remove("correct","incorrect"),this.#g.querySelectorAll("button").forEach(e=>{e.classList.remove("correct","incorrect")})):(this.#m.style.pointerEvents="auto",this.#p.replaceChildren())},o)}#L(){let e=(this.#r/this.#n*100||0).toFixed(0);this.#f.textContent=`Score: ${this.#r} / ${this.#n} (${e}%)`}#S(){this.#n+=1,this.#b.value=this.#n/this.#s}#$(){this.shadowRoot.getElementById("quiz").innerHTML=`
      <div class="completion-message">
        <img src="${/*@__PURE__*/t(f)}" alt="Celebration" width="125" height="121" aria-hidden="true">
    ...
    `,this.shadowRoot.querySelector("header").setAttribute("hidden",""),this.shadowRoot.querySelector("footer").setAttribute("hidden",""),this.#L();let e=this.shadowRoot.getElementById("restartQuiz");e?.addEventListener("click",this.#z,{once:!0})}#v(e){if(Object.prototype.hasOwnProperty.call(this,e)){let t=this[e];delete this[e],this[e]=t}}static defineCustomElement(e="multiply-quiz"){"undefined"==typeof window||window.customElements.get(e)||window.customElements.define(e,v)}}let y=document.querySelector("main");document.addEventListener("quiz-start",e=>{let t=document.querySelector("quiz-intro"),i=document.createElement("multiply-quiz"),o=e.detail.sequential,r=e.detail.multipleChoice;o&&i?.setAttribute("sequential",""),r&&i?.setAttribute("multiple-choice",""),y?.appendChild(i),t?.remove()}),document.addEventListener("quiz-restart",()=>{let e=document.querySelector("multiply-quiz"),t=document.createElement("quiz-intro");y?.appendChild(t),e?.remove()}),window.visualViewport.addEventListener("resize",()=>{document.documentElement.style.height=`${window.visualViewport.height}px`}),p.defineCustomElement(),v.defineCustomElement()}();
//# sourceMappingURL=index.0f9c2a2a.js.map
