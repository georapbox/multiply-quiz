...
`,f=e=>{let r=document.createElement("template");return r.innerHTML=`
  ...
  `,r};class w extends HTMLElement{#e=null;constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(f(b).content.cloneNode(!0))}connectedCallback(){this.#e=this.shadowRoot.querySelector("form"),this.#e.addEventListener("submit",this.#t),this.#e.addEventListener("change",this.#r);let e=l.getItem("options");e&&(this.#e.sequential.checked=e.sequential,this.#e["multiple-choice"].checked=e.multipleChoice)}disconnectedCallback(){this.#e.removeEventListener("submit",this.#t),this.#e.removeEventListener("change",this.#r)}#r=()=>{let e=this.#e.sequential.checked,t=this.#e["multiple-choice"].checked;l.setItem("options",{sequential:e,multipleChoice:t})};#t=e=>{e.preventDefault(),this.dispatchEvent(new CustomEvent("quiz-start",{bubbles:!0,composed:!0,detail:{sequential:e.target.sequential.checked,multipleChoice:e.target["multiple-choice"].checked}}))};static defineCustomElement(e="quiz-intro"){"undefined"==typeof window||window.customElements.get(e)||window.customElements.define(e,w)}}var v={};v=n("aNJCr").getBundleURL("9p9yL")+"star-icon.3c1e655e.svg";let y=`
  :host {
    display: grid;
...
`,C=e=>{let r=document.createElement("template");return r.innerHTML=`
  ...
  `,r};class E extends HTMLElement{#o=[];#i=0;#n=0;#s=0;#a=-1;#l=new Set;#c=new Set;#d=null;#u=null;#h=null;#m=null;#p=null;#g=null;#b=null;#f=null;#w=null;constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(C(y).content.cloneNode(!0))}get sequential(){return this.hasAttribute("sequential")}set sequential(e){this.toggleAttribute("sequential",!!e)}get multipleChoice(){return this.hasAttribute("multiple-choice")}set multipleChoice(e){this.toggleAttribute("multiple-choice",!!e)}connectedCallback(){this.#v("sequential"),this.#v("multipleChoice"),this.#u=this.shadowRoot.getElementById("answerForm"),this.#h=this.shadowRoot.getElementById("question"),this.#m=this.shadowRoot.getElementById("answerInput"),this.#p=this.shadowRoot.getElementById("feedback"),this.#g=this.shadowRoot.getElementById("score"),this.#b=this.shadowRoot.getElementById("progress"),this.#f=this.shadowRoot.getElementById("multipleChoice"),this.#w=this.shadowRoot.getElementById("quitQuiz"),this.#u.addEventListener("submit",this.#t),this.#f.addEventListener("click",this.#y),this.#w.addEventListener("click",this.#C),this.#E(),this.multipleChoice?(this.#m.setAttribute("disabled",""),this.#m.setAttribute("inert",""),this.#m.setAttribute("type","text")):this.#m.focus()}disconnectedCallback(){this.#u.removeEventListener("submit",this.#t),this.#f.removeEventListener("click",this.#y),this.#w.addEventListener("click",this.#C),null!==this.#d&&(clearTimeout(this.#d),this.#d=null)}#E(){this.#o=this.#x(),this.#n=this.#o.length,this.#k()}#t=e=>{e.preventDefault(),null===this.#d&&this.#q()};#y=e=>{let t=e.target.closest("button");null===this.#d&&t&&(this.#m.value=t.textContent,this.#q())};#z=()=>{this.dispatchEvent(new Event("quiz-restart",{bubbles:!0,composed:!0}))};#C=()=>{if(1===this.#s&&null===this.#d)return this.#z();confirm(p("quitQuizConfirm"))&&this.#z()};#x(){let e=[];for(let t=1;t<=10;t+=1)for(let r=1;r<=10;r+=1){let o=t*r;e.push({factor1:t,factor2:r,product:o})}return this.multipleChoice&&e.forEach(t=>{for(t.answerChoices=[t.product];t.answerChoices.length<3;){let r=e[Math.floor(Math.random()*e.length)].product;t.answerChoices.includes(r)||t.answerChoices.push(r)}t.answerChoices=function(e){if(!Array.isArray(e))throw TypeError("Expected an array for first argument");let t=[...e],r=t.length;for(;r;){let e=Math.random()*r--|0,o=t[r];t[r]=t[e],t[e]=o}return t}(t.answerChoices)}),e}#k(){this.sequential?this.#A():this.#Q(),this.#L(),this.#T()}#A(){this.#a+=1;let e=this.#o[this.#a];if(this.#a<this.#n){let{factor1:t,factor2:r}=e;this.#h.textContent=`${t} x ${r} =`,this.multipleChoice&&this.#S(e.answerChoices)}else document.startViewTransition?document.startViewTransition(()=>{this.#$()}):this.#$()}#Q(){let e;if(this.#l.size===this.#n){document.startViewTransition?document.startViewTransition(()=>{this.#$()}):this.#$();return}do this.#a=Math.floor(Math.random()*this.#n),e=this.#o[this.#a];while(this.#l.has(`${e.factor1}-${e.factor2}`))this.#l.add(`${e.factor1}-${e.factor2}`),this.#h.textContent=`${e.factor1} x ${e.factor2} =`,this.multipleChoice&&this.#S(e.answerChoices)}#S(e){this.#f.replaceChildren(),e.forEach(e=>{let t=document.createElement("button");t.setAttribute("data-answer",e),t.type="button",t.textContent=e,this.#f.appendChild(t)})}#q(){let e=parseInt(this.#m.value,10),t=this.#o[this.#a],r=t.product,o=750;if(this.multipleChoice){if(this.#f.setAttribute("inert",""),e===r)this.#f.querySelector(`button[data-answer="${r}"]`).classList.add("correct"),this.#m.classList.add("correct"),this.#i+=1;else{let i=this.#f.querySelector(`button[data-answer="${r}"]`),n=this.#f.querySelector(`button[data-answer="${e}"]`);i.classList.add("correct"),n.classList.add("incorrect"),this.#m.classList.add("incorrect"),o=1e3,this.#c.add({question:`${t.factor1} x ${t.factor2}`,userAnswer:e,correctAnswer:r})}}else this.#m.style.pointerEvents="none",e===r?(this.#p.innerHTML=`
        ...
        `,o=1e3,this.#c.add({question:`${t.factor1} x ${t.factor2}`,userAnswer:e,correctAnswer:r}));this.#L(),this.#d=setTimeout(()=>{this.#m.value="",this.#m.focus(),this.#k(),this.#d=null,this.multipleChoice?(this.#f.removeAttribute("inert"),this.#m.classList.remove("correct","incorrect"),this.#f.querySelectorAll("button").forEach(e=>{e.classList.remove("correct","incorrect")})):(this.#m.style.pointerEvents="auto",this.#p.replaceChildren())},o)}#L(){this.#g.textContent=this.#i}#T(){this.#s+=1,this.#b.value=this.#s/this.#n}#$(){this.shadowRoot.getElementById("quiz").innerHTML=`
...
`,k=document.createElement("template");k.innerHTML=`
  <style>${x}</style>
  <select></select>
`;class q extends HTMLElement{#I=null;constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(k.content.cloneNode(!0))}connectedCallback(){this.#I=this.shadowRoot.querySelector("select");let e=h();Object.entries(u).forEach(([t,r])=>{let o=document.createElement("option");o.value=t,o.textContent=r.name,o.selected=t===e,this.#I.appendChild(o)}),this.#I.addEventListener("change",this.#M)}disconnectedCallback(){this.#I.removeEventListener("change",this.#M)}#M=e=>{this.dispatchEvent(new CustomEvent("language-change",{bubbles:!0,composed:!0,detail:{language:e.target.value||"en"}}))};static defineCustomElement(e="language-select"){"undefined"==typeof window||window.customElements.get(e)||window.customElements.define(e,q)}}let z=document.querySelector("main");document.documentElement.setAttribute("lang",h()),document.addEventListener("quiz-start",function(e){let t=document.querySelector("quiz-intro"),r=document.createElement("multiply-quiz"),o=e.detail.sequential,i=e.detail.multipleChoice;o&&r?.setAttribute("sequential",""),i&&r?.setAttribute("multiple-choice",""),document.startViewTransition?document.startViewTransition(()=>{t?.remove(),z?.appendChild(r)}):(t?.remove(),z?.appendChild(r))}),document.addEventListener("quiz-restart",function(){let e=document.querySelector("multiply-quiz");e&&(document.startViewTransition?document.startViewTransition(()=>{e?.remove(),z?.appendChild(document.createElement("quiz-intro"))}):(e?.remove(),z?.appendChild(document.createElement("quiz-intro"))))}),document.addEventListener("language-change",function(e){m(e.detail.language);let t=document.querySelector("quiz-intro");t&&(t.remove(),z?.appendChild(document.createElement("quiz-intro")))}),window.visualViewport.addEventListener("resize",function(){document.documentElement.style.height=`${window.visualViewport.height}px`}),w.defineCustomElement(),E.defineCustomElement(),q.defineCustomElement()}();
//# sourceMappingURL=index.d1be1d72.js.map
